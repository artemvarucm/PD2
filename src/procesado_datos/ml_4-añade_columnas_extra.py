...
def main():
    ...
    df_upsampled = pd.read_parquet('/Users/alewar/Documents/Universidad/Tercero/PD2/PD2/data/Train/datos_holding_upsampled_nuevo.parquet')
    df_int       = pd.read_csv(
    ...
    df_final.to_parquet('datos_holding_with_runway_and_queue_nuevo_no_parados.parquet', index=False)
    print("✅ Guardado en 'datos_holding_with_runway_and_queue_nuevo.parquet'")
